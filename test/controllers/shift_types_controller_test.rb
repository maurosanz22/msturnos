...
class ShiftTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shift_type" do
    assert_difference('ShiftType.count') do
      post shift_types_url, params: { shift_type: { codigo: @shift_type.codigo, nombre: @shift_type.nombre } }
    end
  ...
  test "should update shift_type" do
    patch shift_type_url(@shift_type), params: { shift_type: { codigo: @shift_type.codigo, nombre: @shift_type.nombre } }
